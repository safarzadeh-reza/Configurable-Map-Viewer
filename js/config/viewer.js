define([
    ...
    Form, TextBox, Button, geometryEngine, array, SimpleLineSymbol, SimpleFillSymbol, Graphic) {
        ...
        baseURL = 'http://localhost'    //localhost or ip address
        baseURLIp = 'http://192.168.100.50'    //localhost or ip address
