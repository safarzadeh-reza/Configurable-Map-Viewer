        ...
        return declare(null, {
            ...
            *******************************/
            ...
            addGraphicsLayer: function () {
                ...
                //     var projectLayer = new FeatureLayer(featureCollectionPoints, {
                ...
                //  var renderer = new UniqueValueRenderer(this.featurePointSymbol, "type");         
                //  //renderer.addValue("point", this.featurePointSymbol);
                //  renderer.addValue({value: "point",
                ...
                //     var spotGraphic = new Graphic(spot, null, {"type": "point","F1397_09": "2735270000","OBJECTID": "1388"}, null);

                //     projectLayer.applyEdits([spotGraphic], null, null);
                //     console.log(projectLayer)
                //   //  }
                //   });

                //   this.map.addLayer(projectLayer);
                ...
                this.sourceGraphics = new FeatureLayer(featureCollectionPolygon, {
                    id: " محدوده ی مورد جست و جوی " + this.topicID,
                ...
                this.bufferGraphics = new FeatureLayer(featureCollectionPolygon, {
                    id: " حریم جست و جوی " + this.topicID,
                ...
                // });
                this.featureGraphics = new FeatureLayer(featureCollectionPoints, {
                    //id: this.topicID + '_FeatureGraphics',
                    id:  " نتایج جست و جوی " + this.topicID,
                    title: 'Attribute Feature Graphics'
                });
                ...
                // this.selectedGraphics = new FeatureLayer(featureCollectionPolygon, {
                //     id: this.topicID + '_SelectedGraphics',
                //     title: 'Attribute Selected Graphics'
                // });

                        //------added by reza safarzadeh

                this.selectedGraphics = new FeatureLayer(featureCollectionPoints, {
                    id: this.topicID +  'عوارض انتخاب شده',
                    title: 'Attribute Selected Graphics'
                });
            ...
            *******************************/
            ...
            addFeatureGraphic: function (feature) {
                ...
                if (symbol) {
                    //------added by reza safarzadeh  
                    this.featureGraphics.setRenderer(renderer);
                    graphic = new Graphic(feature.geometry, null, feature.attributes, null);
                    //-----------------------------------
                   // graphic = new Graphic(feature.geometry, symbol, feature.attributes);
                    ...
                    //------added by reza safarzadeh
                    this.featureGraphics.applyEdits([graphic], null, null);
                    //------------------------------
                }
            },
            ...
            addSourceGraphic: function (geometry) {
                ...
                if (symbol) {
                    //------added by reza safarzadeh  
                    this.sourceGraphics.setRenderer(renderer);
                    graphic = new Graphic(geometry, null, { 'type': 'point' }, null);
                    this.sourceGraphics.applyEdits([graphic], null, null);
                    //-----------------------------------
            ...
            addSelectedGraphic: function (feature) {
                ...
                if (symbol) {
                     ...
                     //------added by reza safarzadeh  
                     this.selectedGraphics.setRenderer(renderer);
                     graphic = new Graphic(feature.geometry, null, feature.attributes, null);
                     //-----------------------------------
                   // graphic = new Graphic(feature.geometry, symbol, feature.attributes);
                    if (this.infoTemplate) {
                    ...
                    //------added by reza safarzadeh
                    this.selectedGraphics.applyEdits([graphic], null, null);
                    //------------------------------
                }
            },
            ...
            addBufferGraphic: function (geometry) {
                ...
                this.bufferGraphics.setRenderer(renderer);
                graphic = new Graphic(geometry, null, { 'type': 'polygon' }, null);
                this.bufferGraphics.applyEdits([graphic], null, null);
