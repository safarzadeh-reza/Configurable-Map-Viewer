    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        addLayerInfo: function (layerInfo) {
            ...
            if (layer) {
                ...
                //**Removing old WeightedSum layers from Identify Task_Safarzadeh
                this.layers = array.filter(this.layers, function (item) {
                    return item.layerInfo["type"] != "WeightedSum";
                });
        ...
        executeIdentifyTask: function (evt) {
            ...
            if (identifies.length > 0) {
                ...
                this.map.infoWindow.setContent('<div class="در حال بارگذاری"></div>');
