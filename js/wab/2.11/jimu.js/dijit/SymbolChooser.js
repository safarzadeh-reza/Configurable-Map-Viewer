...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _localTypes: [
      ...
      'حادثه',
      'علائم اورژانس',
      'علائم عمومی زیرساختی',
      'علائم دولتی',
      'نشانه های کسب و کاری',
      'نقاط مهم',
      'علائم دولتی',
      'نقاط با حاشیه'
    ],
    ...
    _initPointSection:function(){
      ...
      if(this.isPictureMarkerSymbol(this.symbol)){
        ...
        var args2 = {
          "type" : "esriPMS",
          "url" : "http://192.168.100.96:8080/cmv/js/wab/2.11/jimu.js/dijit/SymbolsInfo/ESRI_Markers/marker.png",
        ...
        this.symbol =  new PictureMarkerSymbol(args2);
        this._showBuildInPictureMarkerSymSettings();
    ...
    _requestPointSymJson:function(fileName){
      ...
      this.loadingShelter.show();
                       // safarzadeh editing for offline use of icons`
