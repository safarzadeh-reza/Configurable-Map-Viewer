define({
  root: ({
    ...
    symbolChooser: {
      ...
      symbolSize: "اندازه سیمبل",
      color: "رنگ",
      alpha: "Alpha",
      outlineColor: "رنگ حاشیه",
      outlineWidth: "پهنای حاشیه",
      style: "فرمت",
      width: "پهنا",
      text: "متن",
      fontColor: "رنگ متن",
      ...
      dot: "نقطه چین",
      dashDot: "خط و نقطه",
      dashDotDot: "خط و دو نقطه",
      customImage: "-انتخاب عکس دلخواه-",
      chooseFile: "انتخاب فایل",
      noFileChoosen: "فایلی انتخاب نشده"
    },
    transparency: {
      opaque: "",
      transparent: ""
    ...
    drawBox: {
      ...
      line: "خط",
      polyline: "چندخطی",
      freehandPolyline: "خطوط آزادانه",
      triangle: "مثلث",
      extent: "محدوده",
      circle: "دایره",
      ellipse: "بیضی",
      polygon: "چندضلعی",
      freehandPolygon: "چندضلعی آزادانه",
      text: "متن",
      clear: "پاک کردن"
    },
    popupConfig: {
